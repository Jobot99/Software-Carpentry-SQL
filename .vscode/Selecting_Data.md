...
- Note commands MUST end with a semi-colon, if missing you will get "...>" indicating SQL is waiting for additional commands.
- Typing "; [enter]" will send the command.
...
- You can vary how they are displayed by reordeing your command (so reversing the previous command to "personal, family" will display the data in that order).
